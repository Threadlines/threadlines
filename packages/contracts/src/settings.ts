...
export const DEFAULT_SIDEBAR_PROJECT_GROUPING_MODE: SidebarProjectGroupingMode = "repository_path";
...
export const CodexSettings = makeProviderSettingsSchema(
  {
    ...
    shadowHomePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        providerSettingsForm: {
          placeholder: "~/.codex-threadlines/personal",
          clearWhenEmpty: "omit",
        },
      }),
    ),
...
export const ClaudeSettings = makeProviderSettingsSchema(
  {
    ...
    fallbackModel: Schema.Array(Schema.String).pipe(
      Schema.withDecodingDefault(Effect.succeed([])),
      Schema.annotateKey({ providerSettingsForm: { hidden: true } }),
    ),
...
export const FxSettings = makeProviderSettingsSchema(
  {
    ...
    binaryPath: makeBinaryPathSetting("fx").pipe(
      Schema.annotateKey({
        title: "Binary path",
        description: "Path to the fx binary.",
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let Threadlines spawn the server when needed.",
        providerSettingsForm: {
