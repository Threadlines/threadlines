// This file mostly exists because we want dev mode to say "BadCode (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "BadCode (Dev)" : "BadCode (Alpha)";
...
const developmentMacIconPngPath = join(repoRoot, "assets", "dev", "badcode-dev-macos-1024.png");
