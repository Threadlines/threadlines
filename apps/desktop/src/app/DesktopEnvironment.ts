...
export interface DesktopEnvironmentShape {
  ...
  readonly devRemoteThreadlinesServerEntryPath: Option.Option<string>;
...
const makeDesktopEnvironment = Effect.fn("desktop.environment.make")(function* (
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteThreadlinesServerEntryPath: config.devRemoteThreadlinesServerEntryPath,
    ...
    developmentDockIconPath: path.join(rootDir, "apps", "desktop", "resources", "icon.png"),
  });
});
