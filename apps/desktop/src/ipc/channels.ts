...
export const QUIT_CONFIRMATION_REQUEST_CHANNEL = "desktop:quit-confirmation-request";
export const QUIT_CONFIRMATION_RESOLVE_CHANNEL = "desktop:quit-confirmation-resolve";
