...
import type { EnvironmentId, ExecutionEnvironmentDescriptor } from "@threadlines/contracts";
...
const SERVER_ENVIRONMENT_DESCRIPTOR_PATH = "/.well-known/threadlines/environment";
