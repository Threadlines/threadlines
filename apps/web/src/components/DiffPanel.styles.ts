...
type DiffPanelHostStyle = CSSProperties & Record<`--${string}`, string>;

export const DIFF_PANEL_HOST_STYLE: DiffPanelHostStyle = {
  "--diffs-font-family":
    'var(--font-mono, "Cascadia Mono Variable", "SF Mono", "SFMono-Regular", Consolas, "Liberation Mono", Menlo, monospace)',
