...
function PopoverPopup({
  ...
  /**
   * Classes for the inner viewport, which owns the popup's padding. Without
   * this a compact popover cannot be built: the viewport's padding is not
   * reachable from the popup's own className. Mirrors positionerClassName on
   * the tooltip.
   */
