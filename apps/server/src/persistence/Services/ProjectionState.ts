 ...
 */
import { IsoDateTime, NonNegativeInt } from "@threadlines/contracts";
...
export interface ProjectionStateRepositoryShape {
  ...
  /**
   * Insert or replace multiple projection cursor rows in a single statement.
   *
   * Upserts by projector name. No-op for an empty input.
   */
  readonly upsertMany: (
...
>()("threadlines/persistence/Services/ProjectionState/ProjectionStateRepository") {}
