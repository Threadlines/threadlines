 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@threadlines/contracts";
...
>()("threadlines/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
