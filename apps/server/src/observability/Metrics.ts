...
export const rpcRequestsTotal = Metric.counter("threadlines_rpc_requests_total", {
  description: "Total RPC requests handled by the websocket RPC server.",
});

export const rpcRequestDuration = Metric.timer("threadlines_rpc_request_duration", {
...
export const orchestrationEventsProcessedTotal = Metric.counter(
  "threadlines_orchestration_events_processed_total",
  {
    description: "Total orchestration intent events processed by runtime reactors.",
  },
);

export const providerSessionsTotal = Metric.counter("threadlines_provider_sessions_total", {
  description: "Total provider session lifecycle operations.",
});

export const providerTurnsTotal = Metric.counter("threadlines_provider_turns_total", {
...
export const providerRuntimeEventsTotal = Metric.counter(
  "threadlines_provider_runtime_events_total",
  {
    description: "Total canonical provider runtime events processed.",
  },
);

export const gitCommandsTotal = Metric.counter("threadlines_git_commands_total", {
  description: "Total git commands executed by the server runtime.",
});

export const gitCommandDuration = Metric.timer("threadlines_git_command_duration", {
  description: "Git command execution duration.",
});

export const terminalSessionsTotal = Metric.counter("threadlines_terminal_sessions_total", {
  description: "Total terminal sessions started.",
});

export const terminalRestartsTotal = Metric.counter("threadlines_terminal_restarts_total", {
